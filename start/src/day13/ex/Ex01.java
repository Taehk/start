...
public class Ex01 {
	...
	/*
	 * 	String[] arr = {"123", "456", "789", "일이삼", "542"};
	 *  가 있는 경우
	 *  이 배열이 기억하는 숫자 형태의 문자열을 정수로 바꾼 데이터들의 합과 평균을 구하는 프로그램을 작성하시오.
	 *  
	 *  단, 발생할 수 있는 예외를 가정하여 모두 처리하세여
	...
	public Ex01() {
		String[] arr = new String[]{"123", "456", "789", "일이삼", "542"};
		int[] cal = new int[arr.length];	// arr배열의 크기만큼의 계산용 배열 생성
		int no = 0;	// 정수 변환용 변수
		
		for(int i = 0; i<=arr.length; i++) {
			System.out.println("\t배열의 "+i+"번째를 탐색 중입니다.");
			try {
