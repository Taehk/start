...
/*
  		...
  		어제까지 작업의 내용을 보면 반복적인 내용이 많이 포함되어 있다.
...
/*
 		...
 		new 명령으로 인스턴스를 만들 것이다.
 		이 때 생성자 함수가 동시에 호출될 것이고
 		나는 그 순간에 오라클 드라이버 로딩을 바로 하도록 하고 싶다
 */
	public ScottJDBC() {
		try {
	...
	//	명령 전달 도구 Statement를 요구하면 준비해주는 함수
			...
			/*
			 	양방향 이동가능한 Statement 만들기
			 		...
			 		ResultSet의 Type
			 			...
			 			3. TYPE_SCROLL_SENSITIVE		: scroll 가능하고, 변경된 사항도 적용됨.
			 			
			 		CONCURRENCY 의 TYPE
			 			1. CONCURRENCY_READ_ONLY	: ResultSet 객체의 변경이 불가능
			 			2. CONCURRENCY_UPDATABLE	: ResultSet 객체의 변경이 가능
			 */
		} catch(Exception e) {
